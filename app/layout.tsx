          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16">
              ...
              <nav className="hidden md:flex items-center space-x-4">
                <Link
                  href="/chord-library"
                  className="px-3 py-2 rounded-md text-sm font-medium text-[#0f52ba] hover:bg-gray-100"
                >
                  Chord Library
                </Link>
                <Link
          ...
          <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                ...
                <p className="text-sm text-gray-200">
                  ...
                  chords with visual keyboard representations.
                </p>
              </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-300/30">
              <p className="text-center text-gray-200 text-sm">
                © {new Date().getFullYear()} HarmonicHash.io - Interactive Music
                Theory Application
              </p>
            </div>
          </div>
